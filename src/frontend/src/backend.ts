...
export class Backend implements backendInterface {
    ...
    async getAllHighScores(): Promise<Array<[Principal, HighScore]>> {
    ...
    async setHighScore(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setHighScore(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
